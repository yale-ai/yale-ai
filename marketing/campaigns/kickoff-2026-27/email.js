...
<table role="presentation" class="wrap" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px;max-width:600px;">
  ...
  <tr><td class="pad" align="center" style="padding:0 6px;">
    ...
    <div style="${pixel}color:#6a6a6a;text-transform:none;letter-spacing:0.02em;font-size:13px;line-height:20px;padding-top:14px;"><span style="color:${TEAL};text-transform:uppercase;letter-spacing:0.22em;font-size:12px;">Limited capacity.</span> made for all Yalies interested in AI. first-year or senior? come anyway!</div>
  </td></tr>
  ...
  <tr><td style="padding:28px 0 0;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="${CARD}"><tr><td class="pad" style="padding:28px 28px 26px;">
      ...
      <div style="${body}font-size:14px;line-height:22px;padding-top:14px;">Check out one of our trips from last year, when a bunch of us visited the MIT-IBM Watson AI Lab in Boston, all expenses paid :). We also met up with the Harvard Machine Intelligence Group, had a mixer, and walked around the tech hub that is Boston.</div>
