...
export const SITE = {
  ...
  description:
    "YaleAI is the hub for AI companies, research, networking, and learning on campus. Kickoff Wednesday, September 9 at 8pm, Tsai CITY, sponsored by SpaceXAI: a month of Cursor Pro for everyone, free credits, giveaways, and more. All builders and people interested in AI are invited. All years.",
};
...
export function calendarUrl() {
  const p = new URLSearchParams({
    action: "TEMPLATE",
    text: "YaleAI: Kickoff 2026-27",
    dates: `${KICKOFF.startUtc}/${KICKOFF.endUtc}`,
    location: KICKOFF.location,
    details: `YaleAI kickoff, sponsored by ${KICKOFF.sponsor}. A month of Cursor Pro for everyone who attends, AI credits to win, and what the club is doing this year.\n\nRSVP on Luma: ${LUMA_URL}\n\n${SITE.url}`,
  });
