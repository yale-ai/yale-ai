  ...
  return (
    <footer className={`py-8 sm:py-12 px-4 sm:px-6 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
        ...
        <div className={`font-semibold text-xl sm:text-2xl leading-tight self-start transition-colors duration-300 ${
        ...
        <div className={`text-sm sm:text-md mt-2 sm:mt-0 self-start sm:self-auto transition-colors duration-300 ${
          theme === 'dark' ? 'text-gray-300' : 'text-gray-900'
        }`}>
