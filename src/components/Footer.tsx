      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex flex-col items-center space-y-4">
          ...
          <div className="flex items-center space-x-8">
            {/* GitHub */}
            <Link href="/" className="text-gray-700 hover:text-fuchsia-900 transition-colors duration-200 transform hover:scale-110">
            ...
            {/* LinkedIn */}
            <Link href="/" className="text-gray-700 hover:text-blue-600 transition-colors duration-200 transform hover:scale-110">
              <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            {/* Instagram */}
            <Link href="/" className="text-gray-700 hover:text-pink-600 transition-colors duration-200 transform hover:scale-110">
              <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            {/* Facebook */}
            <Link href="/" className="text-gray-700 hover:text-blue-700 transition-colors duration-200 transform hover:scale-110">
              <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
